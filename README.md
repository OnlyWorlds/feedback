...
No promises on timelines — but small fixes often land fast, and you'll always be able to see exactly where a request stands.
...
Feedback posted on Discord or Reddit worth tracking gets relayed here, so nothing gets lost.

## Labels

- **Surface**: `atlas` · `obsidian` · `api` · `mcp` · `website` · `docs`
- **Type**: `bug` · `request` · `idea`
- **Status**: `triaged` · `building` · `shipped` · `parked`
